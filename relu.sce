...
for l=2:L
    for n=1:N(l)
        W(l,n,1:N(l-1))=rand(1,N(l-1))*0.0001;//'+rand(1,N(l-1))'+rand(1,N(l-1))';
    end
end
em=5000
c=0
...
XX=TsX;//[1,2,1;1,1,1;2,2,2;1,2,5]
TT=TsY;
Dc=105
EEE=[]
for i=1:Dc
